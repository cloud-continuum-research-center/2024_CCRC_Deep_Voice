...
voice_name = "v2/ko_speaker_1" if "Man" in model_name else "v2/ko_speaker_0" # use your custom voice name here if you have on

inputs = processor(text_prompt, voice_name)
...
write_wav(filepath, SAMPLE_RATE, speech_output[0].cpu().numpy())
